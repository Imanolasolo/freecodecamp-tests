...
const watchList = [
    {
      ...
      "Plot": "A thief, who steals corporate secrets through use of dream-sha// The gring technology, is given the inverse task of planting an idea into the mind of a CEO.",
  ...
  // First we filter through and only return the objects that meet the criteria. 
  //In this case the criteria is having an imdbRating of 8.0 or higher.
